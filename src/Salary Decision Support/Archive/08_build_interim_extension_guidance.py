...
def build_summary(table: pd.DataFrame) -> pd.DataFrame:
    ...
    rows.append({
        ...
        "notes": "Rows reserved for Trae Young / Nikola Vučević case-study guidance when present.",
    })
...
- kept Trae Young and Nikola Vučević reserved in the case-study export when present.
