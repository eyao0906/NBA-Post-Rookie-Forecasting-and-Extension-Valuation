...
def build_case_study_table(block1: pd.DataFrame) -> pd.DataFrame:
    keys = {normalize_name("Trae Young"), normalize_name("Nikola Vucevic"), normalize_name("Nikola Vučević")}
...
def main() -> None:
    ...
    log_lines = [
        ...
        "- player_name_key is an accent-insensitive normalized name key used to bridge Nikola Vucevic / Nikola Vučević type spelling differences.",
